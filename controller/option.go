...
func UpdateOption(c *gin.Context) {
	...
	switch option.Key {
	case "QuotaForInviter", "QuotaForInvitee", "AffiliateRewardRatio":
	...
	case "console_setting.channel_status_notices":
		err = console_setting.ValidateConsoleSettings(option.Value.(string), "ChannelStatusNotices")
		if err != nil {
			c.JSON(http.StatusOK, gin.H{
				"success": false,
				"message": err.Error(),
