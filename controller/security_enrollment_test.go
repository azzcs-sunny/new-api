...
func setupSecurityEnrollmentTest(t *testing.T) (*model.User, service.AuthIdentity) {
	...
	require.NoError(t, db.AutoMigrate(&model.User{}, &model.UserSession{}, &model.TwoFA{}, &model.TwoFABackupCode{}, &model.PasskeyCredential{}, &model.AuthFlow{}, &model.UserOAuthBinding{}, &model.Option{}, &model.AffiliateReward{}))
