...
export const THEME_BASE_PRESET: ThemePreset = 'default'
 ...
 * `resolveThemeFont` default of `sans`. The shipped lavender-dream preset
 * stays on the humanist sans so its palette reads cleanly; vivid color
