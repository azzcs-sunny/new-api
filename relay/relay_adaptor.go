...
func GetTaskAdaptor(platform constant.TaskPlatform) channel.TaskAdaptor {
	...
	if !ok {
		return legacyTaskAdaptorForPlatform(platform)
	}
	return jspluginadaptor.New(plugin)
}

func legacyTaskAdaptorForPlatform(platform constant.TaskPlatform) channel.TaskAdaptor {
...
func getTaskAdaptorForRequest(c *gin.Context, platform constant.TaskPlatform) (constant.TaskPlatform, channel.TaskAdaptor) {
	...
	if !ok {
		return platform, legacyTaskAdaptorForPlatform(platform)
	}
	if c != nil {
